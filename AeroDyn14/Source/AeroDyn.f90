...
!BJJ end of plotting info
   ...
   YawAng    = ATAN2( -1._ReKi*TurbineComponents%RotorFurl%Orientation(1,2), TurbineComponents%RotorFurl%Orientation(1,1) ) 
   SYaw      = SIN( YawAng )
   CYaw      = COS( YawAng )
  ...
  YawVel =   ( AvgVelNacelleRotorFurlYaw * rRotorFurlHub(2) + AvgVelTowerBaseNacelleYaw * rNacelleHub(2) &
   ...
   DO IBlade = 1,NB
      ...
      AzimuthAngle = ATAN2( -1._ReKi*DOT_PRODUCT( TurbineComponents%Hub%Orientation(3,:),         & 
      ...
      DO IElement = 1,NElm
         ...
         PitNow    = -1.*ATAN2( -1._ReKi*DOT_PRODUCT( TurbineComponents%Blade(IBlade)%Orientation(1,:),    &

...
QWeight(DOF_TFA1)       = SHP( 1.0_ReKi, TwrFlexL, TwFAM1Sh(:),   1 )  ! The slope of the 1st tower fore-aft     mode shape at the tower-top.
QWeight(DOF_TSS1)       = SHP( 1.0_ReKi, TwrFlexL, TwSSM1Sh(:),   1 )  ! The slope of the 1st tower side-to-side mode shape at the tower-top.
QWeight(DOF_TFA2)       = SHP( 1.0_ReKi, TwrFlexL, TwFAM2Sh(:),   1 )  ! The slope of the 2nd tower fore-aft     mode shape at the tower-top.
QWeight(DOF_TSS2)       = SHP( 1.0_ReKi, TwrFlexL, TwSSM2Sh(:),   1 )  ! The slope of the 2nd tower side-to-side mode shape at the tower-top.
DO K = 1,NumBl       ! Loop through all blades
   QWeight(DOF_BF(K,1)) = SHP( 1.0_ReKi, BldFlexL, BldFl1Sh(:,K), 1 )  ! The slope of the 1st blade flapwise     mode shape at the blade tip.
   QWeight(DOF_BF(K,2)) = SHP( 1.0_ReKi, BldFlexL, BldFl2Sh(:,K), 1 )  ! The slope of the 2nd blade flapwise     mode shape at the blade tip.
   QWeight(DOF_BE(K,1)) = SHP( 1.0_ReKi, BldFlexL, BldEdgSh(:,K), 1 )  ! The slope of the 1st blade edgewise     mode shape at the blade tip.
ENDDO                ! K - Blades
...
DelQ(DOF_TFA1)       = 0.2_ReKi*D2R/SHP( 1.0_ReKi, TwrFlexL, TwFAM1Sh(:),   1 )
DelQ(DOF_TSS1)       = 0.2_ReKi*D2R/SHP( 1.0_ReKi, TwrFlexL, TwSSM1Sh(:),   1 )
DelQ(DOF_TFA2)       = 0.2_ReKi*D2R/SHP( 1.0_ReKi, TwrFlexL, TwFAM2Sh(:),   1 )
DelQ(DOF_TSS2)       = 0.2_ReKi*D2R/SHP( 1.0_ReKi, TwrFlexL, TwSSM2Sh(:),   1 )
DO K = 1,NumBl       ! Loop through all blades
   DelQ(DOF_BF(K,1)) = 0.2_ReKi*D2R/SHP( 1.0_ReKi, BldFlexL, BldFl1Sh(:,K), 1 )
   DelQ(DOF_BF(K,2)) = 0.2_ReKi*D2R/SHP( 1.0_ReKi, BldFlexL, BldFl2Sh(:,K), 1 )
   DelQ(DOF_BE(K,1)) = 0.2_ReKi*D2R/SHP( 1.0_ReKi, BldFlexL, BldEdgSh(:,K), 1 )
ENDDO                ! K - Blades

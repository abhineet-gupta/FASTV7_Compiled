...
!     DIRECTIVITY FUNCTION FOR THE INPUT OBSERVER LOCATION
      ...
      DBAR = (SIN(THETAR)*SIN(PHIR))**2/(1._ReKi+M*COS(THETAR))**4
...
RObserveInt (3) =-RObserve (2)
   ...
   DO J = 1, NumBl
      DO I = 1, BldNodes
          ...
          ChordAngleTE(J,I) = ACOS (RTEObserve(2)/SQRT(RTEObserve(1)**2_ReKi+RTEObserve(2)**2_ReKi+RTEObserve(3)**2))*R2D
          SpanAngleTE(J,I) = ACOS (RTEObserve(3)/SQRT(RTEObserve(1)**2_ReKi+RTEObserve(3)**2))*R2D
          IF (SpanAngleTE(J,I)< 0) SpanAngleTE(J,I)= 180_ReKi+SpanAngleTE(J,I)
          IF (ChordAngleTE(J,I)< 0) ChordAngleTE(J,I)= 180_ReKi+ChordAngleTE(J,I)
